...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    Working with differnt domains and stakeholders at various technical levels is challenging, however I am ready to rise to that challenge at Demant. I am a data engineer with experience in OEM telematics,geospatial data, data streaming and API development in support of last mile delivery companies. My academic background in experimental particle physics has made me more than proficient with python, GitHub and utilizing open source solutions and libraries, I have leadership experience guiding researchers in work and presentation to stakeholders. Combined with my applied experience with PostgreSQL and cloud development solutions like Azure and Azure DevOps in an ETL environment puts me in a great position to identify business needs and learn new tools or technology that is used or will be needed in the future. I am excited join a team of like minded colleagues interested in providing great service and IT support.
