...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    As a physicist and data scientist with hands-on experience as a data engineer, I can drive Lightera's technology forward through experimental design, data analysis and programming. I hold a master's degree in Physics and have a strong background in scientific programming, experimental work with optical fibers and circuit design. My research in particle physics has given me a deep understanding in machine learning and large dataset management. From my time at Wolfram Research, I have developed strong communication skills and the ability to work with international colleagues and clients. I deeply desire to apply the coursework and physics I learned in my studies to real-world applications, I am particularly interested in working with fibers for fiber amplifiers and lasers.
...
\begin{itemize}
    ...
    \item Designed experimental apparatus for testing charge injectors from scintillating materials through scintillating photomultiplier detectors.
