...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    Physicist and Data Scientist with practical experience as a data engineer, seeking a role where I can leverage my data analysis and machine learning expertise to contribute to climate modeling, meteorology, atmospheric physics, or instrumentation supporting these fields. As the climate continues to change in ways that were initially predicted and in new, evolving ways, the need to understand and predict these changes is more critical than ever, whether through satellite observations from space or via interpretative models. I aim to apply my skills in model development, instrumentation, and by supporting private industries through more accurate weather predictions and climate change mitigation efforts.
