...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\
    I am a data engineer with experience using Python, QGIS, and other geospatial analysis libraries and tools. My academic background in physics and experience working with especially large datasets position me well to excel with COWI’s Reality Capture Team. In my most recent role, I was responsible for planning data streams and analyzing GIS data from last-mile delivery vehicles in Denmark. In previous roles, I have led work with AI-powered applications and gained an understanding of how larger models like SORA can be maintained and manipulated. I am tech-minded and ready to design ETL pipelines to effectively and continuously handle UAV and GIS data through clear and well-documented dataflows. COWI is at the forefront of major infrastructure projects, actively building a better tomorrow, and I would love the opportunity to join COWI in its mission
%  
