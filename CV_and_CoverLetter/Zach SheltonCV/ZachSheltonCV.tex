...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\
    I am a data engineer with experience using Python, PostgreSQL, and Azure Virtual Machines, my academic background in physics and my experience working with especially large datasets positions me well to excel in NORDEN’s Data Engineering Team. My work at a data-driven startup in Denmark has prepared me to design effective data pipelines to extract, store, and analyze pertinent data, with a focus on readability for non-technical stakeholders and future-proof documentation at NORDEN. In my previous role at Wolfram Research, I managed software development and research projects, which allowed me to quickly join existing teams, learn new tools, and begin contributing sooner. At NORDEN, I hope to leverage my data engineering and data analysis skills to enable smarter global trade and support a more efficient global economy.
