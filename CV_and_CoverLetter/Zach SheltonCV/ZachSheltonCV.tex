...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\
    I am a data engineer with experience using Python, PostgreSQL, and Docker, my academic background in physics and my experience working with especially large datasets positions me well to excel at HelloFresh. My work at a data-driven startup in Denmark has prepared me to design effective data pipelines to extract, store, and analyze pertinent data, with a focus on readability for non-technical stakeholders and future-proof documentation. My experience at Wolfram Research put me in the mindset to learn about new tools as quickly as possible puts me in the perfect position to be an expert with AWS and Terraform. At HelloFresh, I am ready to grow and contribute to a company focused on helping people eat better!
