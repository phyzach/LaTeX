...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\
   I am a data engineer with experience using PostgreSQL, QGIS and other geospatial analysis libraries and tools. My academic work utilizing machine learning and neual network based solutions and research coordinator work has prepared me to participate actively in data anaylsis at Peak Wind and communicating these results with technical and non-technical stakeholders. I would love the opportunity to assist Peak Wind in their mission to accelerate the world's global energy transition.
%  
