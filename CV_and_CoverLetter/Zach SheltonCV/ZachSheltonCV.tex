...
\begin{document}
\name{ZACHARY SHELTON}
\tagline{\textcolor{Aquamarine}{ Data Engineer | Data Scientist}}
...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    At Novo Nordisk, my STEM background and expertise in Python, Mathematica, and SQL align with improving patients' lives. My physics degree and data analysis experience in particle physics have honed my analytical and problem-solving skills, enabling me to understand scientific principles and monitor data effectively. I am eager to apply my data science expertise, connecting process science to product quality and solving complex problems systematically. At a Danish startup, I designed efficient data pipelines, ensuring clear, documented solutions for non-technical stakeholders. This reflects my ability to manage complexity and deliver scalable solutions. My curiosity for process impact and problem-solving aligns with Novo Nordisk’s innovation goals. from learning in the lab, analog electronics design, and leadership in diverse projects at Wolfram Research, I adapt quickly to new technologies. I am confident in excelling as a Process Engineer or Scientist at Novo Nordisk, supporting colleagues and patients while advancing process science and product quality.
...
\begin{itemize}
    ...
    \item Collaborated with a multinational team for three months at \textbf{FermiLab}, testing and troubleshooting CMS equipment to ensure operational accuracy and reliability.
...
\cvtag{SQL}
\cvtag{GitHub}\\
\cvtag{Mathematica/Wolfram Language}
\cvtag{TensorFlow}
\cvtag{QGIS}
\cvtag{GIS}
\cvtag{Azure VM}
