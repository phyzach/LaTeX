...
\begin{document}
\name{ZACHARY SHELTON}
\tagline{\textcolor{Aquamarine}{Physicist | Data Engineer }}
...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    Physicist and data engineer with experience in scientific programming and statistical data analysis at CERN. Many skills relevant to analyzing divergent particle paths are applicable in nuclear physics. Nuclear energy is fundemental to the future and molten salt reactors represent the cutting edge. After moving to Denmark 3 years ago, I have a deep desire to return to physics and scientific research. My experience with practical data management and engineering can prove invaluable in managing the influx of data coming from various reactor systems, tracking wear of these systems and predicting maintenance needs. My experience in particle and solid state physics give me the perfect opportunity to excel in applied nuclear physics and reactor design, Seaborg's reactor and application on board sea vessels is a project I would be proud to be a part of.
