...
\begin{document}
\name{ZACHARY SHELTON}
\tagline{\textcolor{Aquamarine}{Physicist | Data Scientist | Data Engineer }}
...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    Physicist and data scientist with experience in particle physics, data engineering, and machine learning. I have a strong background in Python, Wolfram Language(Mathematica), and data visualization, I am hopeful to find a role that will allow me to deepen my data analysis and statistics skills while giving me more applied and experimental experience. I am a quick learner and have completed coursework from previous degrees in quantum mechanics along with my experience contributing at FermiLab and CERN, I believe I can succeed in this role. 
