...
\begin{document}
\name{ZACHARY SHELTON}
\tagline{\textcolor{Aquamarine}{Data Scientist | Data Engineer | Physicist}}
...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    Ørsted is a market leader in the green energy transition, and there are numerous engineering and data analysis challenges to overcome as part of Ørsted's and society's push toward a greener future. My professional and personal aspirations are to apply my STEM degree as part of a team that is making a positive impact on the world. As a data engineer and scientist, I am eager to join Ørsted in tackling these challenges. With academic and professional experience in data analysis, machine learning, and data handling, I have utilized various open-source tools such as PostgreSQL, Python, and QGIS to monitor KPIs and develop ETL pipelines. My strong desire to contribute directly and meaningfully to the green energy transition drives me to apply for this position and enables me to quickly learn and adapt to new challenges. I am excited to bring my skills and experience to Ørsted and contribute to the company's mission.
...
\cvtag{PyTorch}
\cvtag{Wolfram Language(Mathematica)}\\
\cvtag{SQL}
\cvtag{GitHub}
\cvtag{TensorFlow}
\cvtag{QGIS}
