...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    Trackman needs unique people and ideas to continue to push projectile tracking software forward, and I would be proud to be a part of the team. I love baseball, I grew up playing and watching baseball, I also grew up watching American Football with my dad! At Trackman, I see an opportunitity to combine my love of baseball with my passion for data science. I have experience with machine learning techinques. I have practical expeience in digital signal processing designing charge injector calibration boards for CERN. I have experience as a data engineer and data scientist working with large datasets and ETL pipelines. I have experience with data visualization and data analysis, and I am proficient in Python, SQL, and Wolfram Language. I am a quick learner and I am excited for the prospect to join Trackman's Team.
