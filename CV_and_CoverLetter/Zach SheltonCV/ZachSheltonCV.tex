...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\
    I am a data engineer with experience in Python, PostgreSQL, and Docker. My academic background in physics and work with large datasets position me to excel at HelloFresh. At a data-driven startup in Denmark, I designed effective data pipelines to extract, store, and analyze data, prioritizing readability for non-technical stakeholders and future-proof documentation. My time at Wolfram Research honed my ability to quickly master new tools, making me well-prepared to become proficient in AWS and Terraform. At HelloFresh, I am eager to grow and contribute to a company dedicated to helping people eat better.
