...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    I am a data engineer with techncial knowledge in Python, PostgreSQL, and Docker. My academic background in physics, combined with my experience in data analysis for experimental particle physics, has equipped me with strong analytical and problem-solving skills. I am now eager to transition my career into data engineering or data science, ideally at a company dedicated to making a positive impact on the world. In my most recent role at a data-driven startup in Denmark, I designed and implemented efficient data pipelines to extract, store, and analyze data. I prioritized creating readable solutions for non-technical stakeholders and ensured thorough, future-proof documentation. Previously, at Wolfram Research, I developed the ability to quickly learn and master new tools, which has prepared me to adapt to diverse technologies and software environments. I am confident in my ability to excel in any role, supporting both my colleagues and customers with my technical skills, collaborative mindset, and commitment to delivering high-quality results.
