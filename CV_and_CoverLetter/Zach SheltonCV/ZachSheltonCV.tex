...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    \bigskip
    \\ 
    Automotive analytics and data analysis is an untapped market for many segments of transportation, I am a data engineer with experience in OEM telematics at a data minded start up supporting last mile delivery companies in Copenhagen. My academic background in experimental particle physics has made me more than proficient with python, GitHub and utilizing open source solutions and libraries. Combined with my applied experience with PostgreSQL and cloud development solutions like Azure and Azure DevOps in an ETL environment puts me in a great position to learn any other tools or technology that is used or will be needed in the future. I am excited join a team of like minded colleagues interested in making transportation and commerce more cost effective and better for the environment.
