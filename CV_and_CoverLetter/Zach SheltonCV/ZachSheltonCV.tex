...
\personalinfo{%
  ...
  \location{Copenhagen, Demark}
    ...
    Trackman needs unique people and ideas to continue advancing projectile tracking technology, and I would be proud to contribute as part of the team. Baseball has been a lifelong passion. I grew up playing and watching the sport, just as I did with American Football alongside my dad. At Trackman, I see an exciting opportunity to merge my love of baseball with my expertise in data science. My background includes machine learning techniques, digital signal processing (including designing charge injector calibration boards for CERN), and hands-on experience as both a data engineer and data scientist working with large datasets, ETL pipelines, and data visualization. I am proficient in Python, SQL, and the Wolfram Language, and I thrive on quickly learning new technologies. I am eager for the opportunity to join Trackman’s team and help drive innovation forward.
